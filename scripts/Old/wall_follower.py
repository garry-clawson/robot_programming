...
# Credit -> https://github.com/nimbekarnd/Wall-follower-in-ROS-using-Python/blob/main/src/motion_plan/nodes/follow_wall.py 
...
pub = rospy.Publisher("/thorvald_001/teleop_joy/cmd_vel", Twist, queue_size=10)
velocity_msg = Twist()
follow_dir = -1
...
def check():
    ...
    rospy.Subscriber('/thorvald_001/front_scan', LaserScan, callback_laser)
